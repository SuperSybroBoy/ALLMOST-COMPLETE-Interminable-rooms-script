    ...
    Callback = function(Value)
        if Value and not connection0 then  -- if toggle is turned on and there is no connection
            connection0 = EntitiesFolder.ChildAdded:Connect(function(entity)
                if entity.Name ~= "TLUB-120" and entity.Name ~= "A-120 Minion" and entity.Name ~= "John" and entity.Name ~= "Noah" and entity.Name ~= "TLAB-278" and entity.Name ~= "ULB-278" and entity.Name ~= "A-245" and entity.Name ~= "A-258" and entity.Name ~= "JohnLocker" and entity.Name ~= "A-278" then
